      ...
      recordButton (0)
{
    ...
    addAndMakeVisible (testCombo = new juce::ComboBox ("test to run"));
    testCombo->setEditableText (false);
    testCombo->setJustificationType (juce::Justification::centredLeft);
    testCombo->setTextWhenNothingSelected (juce::String(""));
    ...
    addAndMakeVisible (label = new juce::Label ("CSL test",
                                          "CSL 6 Demos"));
    label->setFont (juce::Font (juce::Font::getDefaultSerifFontName(), 30.0000f, juce::Font::bold));
    label->setJustificationType (juce::Justification::centredLeft);
    label->setEditable (false, false, false);
    label->setColour (juce::Label::textColourId, juce::Colour (0xfffffc00));
    ...
    addAndMakeVisible (cpuLabel = new juce::Label ("new label",
                                             "0.0%"));
    ...
    addAndMakeVisible (scaleSlider = new juce::Slider ("new slider"));
    scaleSlider->setRange (0, 1, 0);
    scaleSlider->setSliderStyle (juce::Slider::LinearHorizontal);
    scaleSlider->setTextBoxStyle (juce::Slider::NoTextBox, true, 80, 20);
    ...
    addAndMakeVisible (familyCombo = new juce::ComboBox ("test family"));
    familyCombo->setEditableText (false);
    familyCombo->setJustificationType (juce::Justification::centredLeft);
    familyCombo->setTextWhenNothingSelected (juce::String(""));
...
//==============================================================================
void CSLComponent::paint (juce::Graphics& g)
{
    //[UserPrePaint] Add your own custom painting code here..
    //[/UserPrePaint]

    g.fillAll (juce::Colour (0xffaeaeae));
...
void CSLComponent::buttonClicked (juce::Button* buttonThatWasClicked)
{
...
void CSLComponent::comboBoxChanged (juce::ComboBox* comboBoxThatHasChanged)
{
...
void CSLComponent::sliderValueChanged (juce::Slider* sliderThatWasMoved)
{
